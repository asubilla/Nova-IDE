...
use commands::ai::{list_providers, save_api_key, send_ai_message, stream_ai_message, test_connection};
...
use commands::terminal::{get_terminal_output, send_input, spawn_terminal};

#[cfg_attr(mobile, tauri::mobile_entry_point)]
pub fn run() {
    logging::init();
    logging::log("INFO", "main", "Nova IDE starting up");
